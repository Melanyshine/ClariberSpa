...
namespace Capa_Presentacion
{
    public partial class Clientes : Form
    {
        ...
        private void Clientes_Load(object sender, EventArgs e)
        {
            ...
            // Cabeceras del Grid
            dgvClientes.ColumnHeadersDefaultCellStyle.BackColor = COLOR_CABECERA_GRID;
            dgvClientes.ColumnHeadersDefaultCellStyle.ForeColor = COLOR_TEXTO_COMUN;
            dgvClientes.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            dgvClientes.ColumnHeadersDefaultCellStyle.SelectionBackColor = COLOR_CABECERA_GRID;
            dgvClientes.ColumnHeadersHeight = 45;

            // Filas del Grid
            dgvClientes.DefaultCellStyle.BackColor = Color.White;
            dgvClientes.DefaultCellStyle.ForeColor = COLOR_TEXTO_COMUN;
            dgvClientes.DefaultCellStyle.Font = new Font("Segoe UI", 9.5F, FontStyle.Regular);
            dgvClientes.DefaultCellStyle.SelectionBackColor = Color.FromArgb(250, 245, 242); // Selección sutil
            dgvClientes.DefaultCellStyle.SelectionForeColor = COLOR_TEXTO_COMUN;
